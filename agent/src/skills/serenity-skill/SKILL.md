---
name: serenity-skill
description: Supply-chain bottleneck hunter — decompose investment themes into value chains, identify scarce layers, screen candidates, grade evidence, and rank research priorities. Trigger on "产业链/供应链/卡点/瓶颈", "深度调研", "find bottlenecks", "rank candidates". Research support only.
category: strategy
license: MIT
metadata:
  author: muxu-compatible community build (adapted for VibeTrading)
  version: "1.0.0"
  origin: https://github.com/muxuuu/serenity-skill
---
...
- `examples/demo-conversation.md` — research partner and learning-mode example dialogues.
